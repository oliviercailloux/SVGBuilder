...
public class ZoneTests {
  ...
  void testFromOrigin() throws Exception {
    ...
    assertEquals("(0.0, 0.0) → (10.0, 10.0)", origin.enclosing(Point.given(10d, 10d)).coordinates());
  }

  @Test
  void testFromNotOrigin() throws Exception {
    Zone start = Zone.at(Point.given(10d, 10d));
    ...
    assertEquals("(10.0, 10.0) → (10.0, 10.0)", start.enclosing(Point.given(10d, 10d)).coordinates());
    assertEquals("(10.0, 10.0) → (20.0, 20.0)", start.enclosing(Point.given(20d, 20d)).coordinates());
  }
}
