...
When you want a vector, use a Displacement if you intend to use it for computing coordinates; transform it to a Point or a Zone for representing an absolute location or rectangle; from the Zone obtain a Size when you want to represent a (positive) size.
