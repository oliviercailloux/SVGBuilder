...
== Todo
Should make Displacement an interface, use the record only as an internal implementation of it; and introduce a Size class that is a positive displacement.
